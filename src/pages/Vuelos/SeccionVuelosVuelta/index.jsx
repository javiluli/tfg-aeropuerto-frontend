...
const SeccionVuelosVuelta = ({ vuelos, setVueloVuelta }) => {
				...
				<Grid container spacing={4}>
					...
					{vuelos !== null ? (
						<Grid item xs={12}>
							<ListOfVuelos
								vuelos={vuelos}
								radioName="vueloVuelta"
								onVueloSeleccted={(id) => setVueloVuelta(vuelos.find(({ vuelo }) => vuelo.idVuelo === id))}
							/>
						</Grid>
					) : (
						<CircularProgress />
...
export default SeccionVuelosVuelta
